...
function wpmu_customize_register( $wp_customize ) {
	...
	********************************************/
	...
	$textcolors[] = array(
		'slug' => 'wpmu_color2',
		'default' => '#183c5b',
		'label' => __( 'Secondary colour', 'wpmu' )
	);
	...
	$textcolors[] = array(
		...
		'default' => '#666',
		'label' => __( 'Links colour (on hover)', 'wpmu' )
	);
...
function wpmu_add_color_scheme() {
	...
	****************/
	...
	$color_acc = get_option( 'wpmu_coloracc' );
	$color_head = get_option( 'wpmu_colorhead' );
